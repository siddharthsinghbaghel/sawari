        ...
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>Car Ki Sawari <span><i className="ri-user-3-fill"></i>4</span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='-ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>Bike Ki Sawari <span><i className="ri-user-3-fill"></i>1</span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>Auto Ki Sawari <span><i className="ri-user-3-fill"></i>3</span></h4>
                    <h5 className='font-medium text-sm'>3 mins away </h5>
